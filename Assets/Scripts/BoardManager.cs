...
public class BoardManager : MonoBehaviour
{
    ...
    //Sets up the outer puddles and ground (background) of the game board.
    void BoardSetup()
    {
        //Instantiate Board and set boardHolder to its transform.
        boardHolder = new GameObject("Board").transform;

        //Loop along x axis, starting from -1 (to fill corner) with ground or outer puddle edge tiles.
        for (int x = 0; x < columns; x++)
        {
            //Loop along y axis, starting from -1 to place ground or outer puddle tiles.
            for (int y = 0; y < rows; y++)
            {
                //Choose a random tile from our array of ground tile prefabs and prepare to instantiate it.
    ...
    {
        //Creates the outer puddles and ground.
        BoardSetup();
